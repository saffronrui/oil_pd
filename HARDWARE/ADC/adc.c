...
{ 	
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;		//模拟输入引脚AIN0输入引脚配置
	GPIO_Init(GPIOA, &GPIO_InitStructure);	

	//PA1 作为模拟通道输入引脚                         
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;		//模拟输入引脚AIN1输入引脚配置
	GPIO_Init(GPIOA, &GPIO_InitStructure);	

	//PA2 作为模拟通道输入引脚                         
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;		//模拟输入引脚AIN2输入引脚配置
	GPIO_Init(GPIOA, &GPIO_InitStructure);	
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;		//模拟输入引脚AIN10 - AIN15 输入引脚配置
